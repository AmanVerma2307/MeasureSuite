...
def dataLoader(args):
    ...
    if(args.dataset == 'soli'):
        ...
        #X_train = np.transpose(np.load('./_data/soli/X_train_Seen-IAR-NonShuffled_SOLI.npz')['arr_0'],(0,4,1,2,3))
        #X_dev = np.transpose(np.load('./_data/soli/X_dev_Seen-IAR-NonShuffled_SOLI.npz')['arr_0'],(0,4,1,2,3))
        #y_train = np.load('./_data/soli/y_train_Seen-IAR-NonShuffled_SOLI.npz')['arr_0']
        #y_dev = np.load('./_data/soli/y_dev_Seen-IAR-NonShuffled_SOLI.npz')['arr_0']
        #y_train_id = np.load('./_data/soli/y_train_id_Seen-IAR-NonShuffled_SOLI.npz')['arr_0']
